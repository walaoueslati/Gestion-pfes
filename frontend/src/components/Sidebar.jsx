...
function Sidebar(){
    return(
        ...
        <nav class="mt-4 space-y-1">
            ...
            <a href="./Actualite" class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-100">
            ...
            <a href="./Actualitedirigee" class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-100">
            ...
            <a href="./Affectation" class="flex items-center space-x-2 px-4 py-2 hover:bg-gray-100">
